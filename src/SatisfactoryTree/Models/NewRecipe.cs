...
{
    public class NewRecipe(string? className, string? displayName, List<KeyValuePair<string?, decimal>>? ingredients, List<KeyValuePair<string?, decimal>>? products, string? producedIn, decimal manufactoringDuration, bool isAlternateRecipe)
    {
        //Common properties
