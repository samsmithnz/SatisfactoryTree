namespace SatisfactoryTree.Logic.Models
{
    public class Plan
    {
        ...
        public List<Factory2> Factories { get; set; } = new();
        ...
        public void UpdatePlanCalculations(FactoryCatalog factoryCatalog)
        {
            ...
            foreach (Factory2 factory in Factories)
            {
                ...
                //        {
                //            foreach (ItemIngredient missingIngredient in componentItem.MissingIngredients)
                //            {
                //                neededIngredients.Add(missingIngredient.Name);
                //            }
                //        }
                //    }
                //}
