...
//            }
//            Factory2? factory = _planService.Plan.Factories[0];
...
//            List<ItemIngredient> missingBefore = _planService.GetMissingIngredients(factory.Id);
//            Assert.IsTrue(missingBefore.Find(i => i.Name == "IronIngot") != null, "IronIngot should be missing before auto-add");
